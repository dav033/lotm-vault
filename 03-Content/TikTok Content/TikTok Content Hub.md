...
The current benchmark is the MCP universe `Lord of Mysteries — Error Pathway`, interpreted through [[Error Pathway (disambiguation)]]. Its three parts should feel like different productions: a suspicious career pitch, unauthorized conceptual patch notes, and workplace safety training for people whose identity may no longer be exclusively theirs.

## Non-negotiable rules

- The joke must be inseparable from the real mechanic. Generic meme filler is not a comedy format.
- The cards may simplify wording, but they must not simplify ontology. A Symbolism, Authority, Power, method, visual effect, or group-level concept remains in its own category.
