...
- **Artificial Life Creation**: By using fragmented [Souls](https://lordofthemysteries.fandom.com/wiki/Soul "Soul") and other materials, an **Ancient Alchemist** can complete the ultimate form of **Life Transmutation**.
	- They are able to create different golems that can be used for combat or other tasks.
		- The golems they can create includes **Stone Golems**, **Mud Golems**, and **Steel Golems**.
			- For example, a stone bird, pulsating with vitality, with tough, rigid feathers and eyes that appeared to be adorned with two rubies; it could flap its wings and ascend dozens of meters into the air.
...
- All their previous abilities has been enhanced.
	- **Creature Commanding**: A qualitative upgrade to **Plant & Insect Commanding**. They can control **Beyonder** creatures with low intelligence and reduce their insanity for a short period of time.
		...
		- Even humans could be affected to a certain extent, causing their body to more rapidly develop and grow under the influence of a **Ancient Alchemist's Life Aura**.
		...
		- **Cross-breeding**: Their **Cross-breeds** can now possess a [Soul](https://lordofthemysteries.fandom.com/wiki/Soul "Soul").****
...
This maps conceptual origin; it does not mean a Sequence 4 Ancient Alchemist owns an Authority.

- [[Life (Mother)]] → **Mutation**, **Artificial Life Creation**, **Life Aura**, **Cross-breeding** — each echoes the Sequence 0 Life authority's power to make creatures mutate uncontrollably and to grant Life to constructed or reborn things.
- [[Mother (Authority)]] → **Healing** — the enhanced Surgical Mastery/Treatments/Soul Suture cluster corresponds to the "Healing (Treatment)" lower authority, itself derived from Mother and Life (see [[0 - Mother]]).
- **Creature Commanding** and **Animal Transformation** have no clearly supported Authority beyond general Nature symbolism and are left unmapped.
